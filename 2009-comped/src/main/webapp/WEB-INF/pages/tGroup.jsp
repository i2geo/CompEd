...
<c:set var="getBackAction" scope="session" value="showAbstractTopic"/>

<!-- define the chooseMe link -->
<c:set var="chooseMe">
	<a href='javascript:window.opener.chooseNode("${topic.uriSuffix}_r");'>
		[<fmt:message key='button.chooseMe'/>]
	</a>
</c:set>

<c:set var="editLink">
	<a href="<s:url action="editAbstractTopic"><s:param name="id" value="topic.id"/></s:url>">
