...
<s:form name="userForm" action="saveUser" method="post" validate="true">
    ...
    <li>
        ...
        <div class="group">
            ...
            <div>
                <s:set name="language" value="user.language" scope="page"/>
                <appfuse:language name="user.language" prompt="" default="${language}"/>
                <p>
                    <label for="user.language">
                        <fmt:message key="user.language"/> <span class="req">*</span>
                    </label>
                </p>
            </div>
            <div class="left">
